    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, services_1.authenticationService.signUp({ email: email, password: password })];
                case 2:
                    result = _b.sent();
                    console.log("uh");
                    return [2 /*return*/, res.status(http_status_1["default"].CREATED).send(result)];
                case 3:
                    error_1 = _b.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, services_1.authenticationService.signIn({ email: email, password: password })];
                case 2:
                    result = _b.sent();
                    return [2 /*return*/, res.status(http_status_1["default"].OK).send(result)];
                case 3:
                    error_2 = _b.sent();
                    return [2 /*return*/, res.sendStatus(http_status_1["default"].BAD_REQUEST)];
                case 4: return [2 /*return*/];
